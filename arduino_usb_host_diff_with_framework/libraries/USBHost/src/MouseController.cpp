...
void mouseScrolled() __attribute__ ((weak, alias("__mouseControllerEmptyCallback")));
...
int MouseController::getWheelChange() {
	int r = dz;
	dz = 0;
	return r;
}

void MouseController::OnMouseScroll(MOUSEINFO *mi) {
	dz += mi->dZ;
	mouseScrolled();
}
