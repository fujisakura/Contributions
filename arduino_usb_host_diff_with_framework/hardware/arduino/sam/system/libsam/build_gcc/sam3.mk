...
SUB_MAKEFILES=gcc.mk release.mk win.mk sam3s.mk
...
VPATH+=$(PROJECT_BASE_PATH)/source/spansion
VPATH+=$(PROJECT_BASE_PATH)/source/spansion/dbg
VPATH+=$(PROJECT_BASE_PATH)/source/spansion/usb
VPATH+=$(PROJECT_BASE_PATH)/source/spansion/usbfunction
VPATH+=$(PROJECT_BASE_PATH)/source/spansion/usbhost
...
INCLUDES += -I$(PROJECT_BASE_PATH)/source/spansion
INCLUDES += -I$(PROJECT_BASE_PATH)/source/spansion/dbg
INCLUDES += -I$(PROJECT_BASE_PATH)/source/spansion/usb
INCLUDES += -I$(PROJECT_BASE_PATH)/source/spansion/usbfunction
INCLUDES += -I$(PROJECT_BASE_PATH)/source/spansion/usbhost
...
C_SRC+=$(wildcard $(PROJECT_BASE_PATH)/source/spansion/*.c)
C_SRC+=$(wildcard $(PROJECT_BASE_PATH)/source/spansion/dbg/*.c)
C_SRC+=$(wildcard $(PROJECT_BASE_PATH)/source/spansion/usb/*.c)
C_SRC+=$(wildcard $(PROJECT_BASE_PATH)/source/spansion/usbfunction/*.c)
C_SRC+=$(wildcard $(PROJECT_BASE_PATH)/source/spansion/usbhost/*.c)
